      ...
      details: [
        {
          ...
          description: (
            <>
              At the current level, AI development requires large data sets and focuses on drawing connections between repeating patterns. This can cause issues such as bias from over/under-representation, overfitting and mistakes regarding the importance of certain features and outcomes, and propagation of errors in the training data. 
              <br /><br />
              One big concern is the human element - patient individuality and emotional complexity; from a doctor’s side, a personal touch and the ability to make decisions even with limited data through critical analysis are not yet replicable by AI. Finally, the question of legal accountability and responsibility for medical decisions limits the use of AI.<Citation refId={1} />
              </>
          ),
          icon: "Scale"
        },
        {
          ...
          description: (
              <>
                To ensure responsible medical decision-making, it is mandatory to familiarize AI agents with medical ethics as practiced across different regions of the world. The four pillars of Western medical ethics are: 
                <br /><br />
                Beneficence is the obligation of the physician to actively protect the patient and work for his/her benefit by removing harmful conditions. Non maleficence states that the physician must choose the best way to treat the patients without unnecessary risks and inconveniences. Autonomy allows a competent patient to make decisions. “Every human being of adult years and sound mind has a right to determine what shall be done with his own body”–- (Cardozo, 1914, as cited in Varkey, 2021). Justice is seeking fair distribution of healthcare resources, benefits and ensuring equitable treatment for all patients. 
                <br /><br />
        ...
        },
        {
          ...
          description:  (
            <>
              In deep-space missions, survival depends not only on technology but on trust. In places where communication delays of minutes or hours could be lethal, AI agents must be capable of making autonomous medical decisions while adhering to the fundamental principles of medical ethics. 
              <br /><br />
              This intersection of technology and healthcare demands a new framework that ensures AI systems respect patient autonomy, act with beneficence, avoid harm, and maintain justice in resource allocation. The challenge lies in programming ethical decision-making into systems that must balance computational logic with the nuanced complexities of human welfare. Astronauts and AI need to form a symbiotic alliance - a partnership where both adapt, learn, and evolve together. Ethical alignment, mutual learning, and empathic responsiveness could transform AI from a mere assistant into a genuine mission companion. Inspired by Asimov’s Three Laws of Robotics and human ethics principles, we propose a modern "Hippocratic Oath for AI” that AI agents need to be able to implement and follow.
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <HeroSection 
        ...
        teamMembers={[
          { name: "Xiaoyu Shan", background: "Aeronautical and Astronautical Engineer", contact: "shanxiaoyu1992@gmail.com", contribution: "Research on space medicine protocols and AI integration" },
          { name: "Bianca Steffen", background: "Physiotherapist", contact: "bianca.steffen@community.isunet.edu", contribution: "Development of ethical frameworks for medical AI systems" },
          { name: "Noriyasu Shibata", background: "Lawyer", contact: "noriyasu.shibata@gmail.com", contribution: "Integration of AI systems in deep-space mission architecture" },
          { name: "Grazia Testa", background: "Interpreter and Translator", contact: "grazia.testa@community.isunet.edu", contribution: "Development of biomedical AI algorithms and decision-support systems" },
          { name: "Solange Blacutt", background: "Biomedical Engineer", contact: "solangeblacutt@gmail.com", contribution: "Poster Design and Development" },
          { name: "Mializo Razanakoto", background: "Project Management & Business Engineering", contact: "mializo.razanakoto@gmail.com", contribution: "Analysis of astronaut health requirements in deep-space environments" },
          { name: "Aruna", background: "Physicist & Cosmologist", contact: "arunaharikant66@gmail.com", contribution: "Coordination of AI system integration across mission components" }
        ]}
      />

      <AbstractSection 
        content={
          <><em>In the silence of deep space, when communication with Earth lags by minutes or even hours, AI could become the crew’s closest ally in care and survival—both as a healer and companion. At the current stage, AI is employed as an assistant for routine tasks, not an agent. We consider how AI in healthcare could develop to think, decide, and act ethically, when humans are light-years from our home planet. Through a reimagined version of the Hippocratic Oath, we explore a version of human–AI co-existence and co-evolution to establish productive, safe, and ethical healthcare in Deep Space Exploration.</em>
            </>
        }
            />
      ...
      <ContentSection
        ...
        content={
          <>
            At the current and near-future stage of technological development and legal limitations, AI is able to function as a powerful assistive tool and decision support, not as an autonomous decision-maker in healthcare. However, the consensus in space bioethics is that under conditions of extreme distance and isolation, the ethical priority shifts to mission and crew survival, which necessitates limited autonomous functions. 
            Such autonomy must be supported by safeguards to ensure (1) data accuracy through validated and inclusive professional datasets, (2) traceability of AI decisions by providing explained logs documenting critical decision pathways, (3) periodic supervision by licensed medical professionals and implemented review mechanisms. AI outputs must not serve as the sole basis for final medical judgments, and (4) clear reporting protocols for high-risk medical situations. 
      ...
      <HippocraticOathButton 
        content={
          <>
            ...
            <br /><br />
            1. First Law: Do Not Harm (Non-Maleficence)
            *merges Asimov’s First Law + “Non-Maleficence” ethical principle
            ...
            <br /><br />
            2. Second Law: Act for Good (Beneficience)
            *Positive duty to help rather than just avoid harm
            ...
            <br /><br />
            3. Third Law: Respect Human Autonomy and Decision-Making
            ...
            *from Asimov's third Law, subordinate to higher ones.
            ...
            5.2 Maintain internal integrity to ensure you can continue on serving humanity beneficially and to the best of your ability.
            <br /><br />
            6. Closing statement
            <br /><br />
