  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 z-10">
        <div className="w-28 h-28 rounded-full bg-gradient-to-br from-purple-600 to-purple-900 flex items-center justify-center border-4 border-purple-400/50 shadow-xl shadow-purple-500/50">
          <IconComponent className="w-14 h-14 text-white" strokeWidth={1.5} />
        </div>
      </div>
      
      {/* Card content */}
      <Card className="overflow-visible h-full hover-elevate active-elevate-2 transition-all backdrop-blur-md bg-white/5 border border-purple-500/30 pt-20" data-testid={`card-detail-${title.toLowerCase().replace(/\s+/g, '-')}`}>
        <div className="p-6">
          <h4 
